...
export function HeroSection() {
  ...
  return (
    <section className="min-h-[70vh] py-12 flex items-center justify-center relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              <Button variant="outline" size="lg" className="min-w-[160px] bg-transparent">
            ...
            <div className="flex justify-start space-x-6">
              <a
                ...
                className="text-[#333] hover:text-[#000] transition-colors duration-200"
                title="GitHub"
              >
              ...
              <a
                ...
                className="text-[#EA4335] hover:text-[#D33B2C] transition-colors duration-200"
                title="Email"
              >
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#25D366] hover:text-[#1DA851] transition-colors duration-200"
                title="WhatsApp"
              >
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
